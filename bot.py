...
async def start(client, message):
	await message.reply_text(text =f"Hello **{message.from_user.first_name }** \n\n __I am simple Google Translater Bot \n I can translate any language to you selected language__",reply_to_message_id = message.message_id ,parse_mode="markdown", reply_markup=InlineKeyboardMarkup([ [                    InlineKeyboardButton("Support 🇮🇩" ,url="https://t.me/LetterU") ],               [InlineKeyboardButton("Subscribe 🧐", url="https://t.me/BitLy_Shorten_Support") ]   ]  ) )
...
async def echo(client, message):
 ...
 keybord1= InlineKeyboardMarkup( [
	...
	[InlineKeyboardButton(" Lanjut --->",callback_data = "page2")
	]
	] )
...
async def translate_text(bot,update):
  ...
  keybord5 = InlineKeyboardMarkup([
         ...
         InlineKeyboardButton("Lanjut --->",callback_data = "page6")
         ]  ])
  ...
  keybord4 = InlineKeyboardMarkup([
          ...
          InlineKeyboardButton("Lanjut --->",callback_data = "page5")
          ]
  ...
  keybord3 = InlineKeyboardMarkup([
                ...
                InlineKeyboardButton(" Lanjut --->",callback_data = "page4")
                ]
  ...
  keybord2= InlineKeyboardMarkup([
           ...
           InlineKeyboardButton(" Lanjut --->",callback_data = "page3"),
           ]
            ])
